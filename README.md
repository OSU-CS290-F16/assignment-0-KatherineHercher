...
6. Publish your index and blog pages under your personal ENGR web space (or ONID, if you're not an Engineering student) under a URL like this: http://web.engr.oregonstate.edu/~hercherk/cs290/. **I wasn't confident that I published correctly on the ENGR server, so here is a link for my publication on ONID as well. http://people.oregonstate.edu/~hercherk/ **  For help publishing to your web space, see one of these pages:
